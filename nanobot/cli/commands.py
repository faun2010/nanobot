...
def gateway(
    ...
    llm_trace: bool = typer.Option(
        ...
        help="Enable/disable LiteLLM request/response trace logging",
    ),
    llm_trace_file: str | None = typer.Option(
        None,
        "--llm-trace-file",
        help="LiteLLM trace JSONL path (overrides daily files in workspace/.logs)",
    ),
):
    ...
    if trace_enabled:
        ...
        console.print(f"[green]✓[/green] LiteLLM trace enabled: {trace_target}")
